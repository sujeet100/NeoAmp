...
(function () {
  ...
  // Per-provider selectors are bundled here in the PROVIDERS registry (the single source of
  // truth). NeoAmp makes no network requests, so there is no remote-config layer to merge in.
