...
(function () {
  ...
  if (!NA) {
    console.error("[NeoAmp] backend (content.js) not present");
    return;
  }
  ...
  function showShortcuts() {
    ...
    var panel = h(
      "div",
      { class: "neoamp-sc", role: "dialog", "aria-label": "Keyboard shortcuts" },
      [h("div", { class: "neoamp-sc-h" }, [h("span", { text: "Keyboard shortcuts" }), close]), list]
    );
